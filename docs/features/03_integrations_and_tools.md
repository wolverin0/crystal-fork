...
*   **Status:** **High Priority**. Ready to implement using existing Terminal Panel infrastructure.
...
## 5. Local Voice Alerts (Piper TTS)
... [rest of the file] ...

## Summary Roadmap

1.  **Immediate:** Implement Lazygit panel.
2.  **Short Term:** Add Gitleaks scanning to the "Worker Bee" prototype and implement Watchexec auto-testing.
3.  **Medium Term:** Experiment with Piper TTS for "Build Failed" alerts.
4.  **Long Term:** Embedded Browser for "Claude in Chrome".
